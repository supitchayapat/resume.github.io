  ...
  render() {
    if(this.props.data){
      var education = this.props.data.education.map(function(edu){
       ...
       var Hightschool = this.props.data.Hightschool.map(function(job){
    ...
    return (
      ...
      <div className="row Hightschool">
         <div className="three columns header-col">
                <h1><span>Hightschool</span></h1>
         </div>
      ...
      <div className="row skill">
         ...
         <div className="nine columns main-col">
            <p>The main skill sets below outline the variety of skills performed within my current role at University
            </p>
				<div className="bars">
				   <ul className="skills">
					  {skills}
